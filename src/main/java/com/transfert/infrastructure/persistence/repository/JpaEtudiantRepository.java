// infrastructure/persistence/repository/JpaEtudiantRepository.java
...
interface SpringDataEtudiantRepository extends org.springframework.data.jpa.repository.JpaRepository<EtudiantEntity, UUID> {
